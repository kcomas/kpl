        ...
        ON(NULL, DFN, CN(E, IN("l")),
            ON(NULL, CST,
                AN(NULL, TN(ST), L(2, ZN("i", TN(I6)),
                    ZN("n", AN(NULL, TN(UN), L(2, ZN("y", TN(VD)), ZN("z", CN(T, IN("l")))))))),
...
T(movep) {
    V(TPGM(movep), RN(AN(NULL, LN(NULL, L(4,
        ...
        ON(NULL, DFN, CN(E, IN("s")), ON(NULL, MTCH, NULL, LN(NULL, L(2,
            ZN("x", IN("x")),
            ZN("y", IN("y"))
        )))),
        CN(P1, IN("s"))
...
T(mapstrs) {
    V(TPGM(mapstrs), RN(AN(NULL, LN(NULL, L(3,
        ...
        ON(NULL, DFN, CN(E, IN("m")), ON(NULL, MUL,
...
T(retest) {
    V(TPGM(retest), RN(AN(NULL, LN(NULL, L(3,
        ...
        ON(NULL, DFN, CN(E, IN("t")), VN(NULL, L(4,
            ...
            AN(NULL, IN("r"), L(1, CS("Ab"))),
            AN(NULL, IN("r"), L(1, CS("abc"))),
            AN(NULL, IN("r"), L(1, CS("a")))
        ))),
        CN(P1, IN("t"))
    )), NULL)));
}
