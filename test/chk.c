...
T(vridx) {
    ...
    V(RN(AN(TS(VD), LN(LT(1, "v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)), L(3,
        ...
        ON(TS(VD), MTCH,
            ...
            LN(LT(1, "e", FLG(-1, LTE_FLG(Y)), TV(ER, TS(U6))), L(1,
                ZTN("e", TS(VD), ON(TS(VD), DUMP, SN(U5, U5(1)), EN("e", FLG(-1, LTE_FLG(Y)), TV(ER, TS(U6))))))))
    )), NULL)));
    te_f(tsg);
    te_f(ttsg);
    te_f(vr);
