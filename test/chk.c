...
T(fnscope) {
    ...
    V(RN(AN(TS(VD), LN(LT(3, "b", FLG(-2, LTE_FLG(F)), te_c(fn), "a", FLG(-1, LTE_FLG(F)), te_c(fn), "c", FLG(-4, LTE_FLG(F)), te_c(fn)), L(5,
        ...
        ON(te_c(fn), DFN, EN("b", FLG(-2, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)),
            ...
            ON(te_c(fn), DFN, EN("c", FLG(-4, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)),
                LN(LT(2, "a", U6(0), NULL, "n", FLG(0, LTE_FLG(A)), TS(F6)),
...
T(unmatch) {
    ...
    V(RN(AN(TS(VD), LN(LT(2, "u", FLG(0, LTE_FLG(L)), te_c(u), "c", FLG(1, LTE_FLG(L) | LTE_FLG(E)), TS(SG)), L(4,
        ...
        ON(TS(SG), DFN, EN("c", FLG(1, LTE_FLG(L) | LTE_FLG(E)), TS(SG)), ON(TS(SG), MTCH,
            ...
            LN(LT(2, "a", FLG(-1, LTE_FLG(Y)), TS(I6), "b", FLG(-2, LTE_FLG(Y)), TS(I6)), L(3,
                ZTN("a", TS(_M), AN(TS(SG), CS("a %ld"), L(1, EN("a", FLG(-1, LTE_FLG(Y)), TS(I6))))),
                ZTN("b", TS(_M), AN(TS(SG), CS("b %ld"), L(1, EN("b", FLG(-2, LTE_FLG(Y)), TS(I6))))),
...
T(ns) {
    ...
    V(RN(AN(TS(VD), LN(LT(2, "s", FLG(0, LTE_FLG(L)), TS(SG), "f", FLG(1, LTE_FLG(L)), te_c(u)), L(3,
        ...
        ON(TS(VD), DUMP, SN(U5, U5(1)), ZTN("v", TS(WSG), EN("f", FLG(1, LTE_FLG(L)), te_c(u))))
    )), NULL)));
    te_f(u);
}
...
T(iline) {
    ...
    V(RN(AN(TS(VD), LN(NULL, L(1,
        ON(TS(VD), DUMP, SN(U5, U5(1)), ZTN("v", TS(WSG),
            AN(te_c(u),
...
T(vridx) {
    ...
    te *ttsg = type_te_i_v(&al_te, NULL, 2, te_c(tsg), te_c(tsg));
    te *vr = TV(VR, te_c(tsg));
    te *u = TH(UN, 2, "e", chk_rt_err_t(&al_te), "v", te_c(wtsg));
    V(RN(AN(TS(VD), LN(LT(1, "v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)), L(5,
        ON(te_c(vr), DFN, EN("v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)),
            ON(te_c(vr), CST, NN(T, te_c(vr)),
                VN(te_c(ttsg), L(2,
                    VN(te_c(tsg),
        ...
        ON(TS(VD), DUMP, SN(U5, U5(1)), AN(te_c(u),
            EN("v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)),
            L(1, ON(TS(I6), SUB, NULL, SN(I6, I6(1)))))),
        ON(TS(VD), DUMP, SN(U5, U5(1)), AN(TS(WSG), ZTN("v", te_c(wtsg), AN(te_c(u),
            EN("v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)),
            L(1, ON(TS(I6), SUB, NULL, SN(I6, I6(1)))))), L(1, SN(I6, I6(0))))),
        ON(TS(VD), MTCH,
            LN(NULL, L(1, AN(te_c(u), EN("v", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(vr)), L(1, SN(I6, I6(3)))))),
...
T(nscope) {
    ...
    tbl *fas = fld_type_tbl_i(true, 0);
    te *fa = TFS(NF, TS(F6), args, fas);
    tbl *fbs = fld_type_tbl_i(true, 1, "x", TS(F6), 0);
    te *fb = TFS(NF, TS(F6), tbl_c(args), fbs);
    V(RN(AN(TS(VD), LN(LT(2, "x", FLG(0, LTE_FLG(L)), TS(F6), "fa", FLG(-1, LTE_FLG(F)), te_c(fa)), L(4,
        ON(TS(F6), DFN, EN("x", FLG(0, LTE_FLG(L)), TS(F6)), SN(F6, F6(6.6))),
        ON(te_c(fa), DFN, EN("fa", FLG(-1, LTE_FLG(F)), te_c(fa)), ON(te_c(fa), CST, NN(T, te_c(fa)),
        ...
        AN(TS(F6), EN("fa", FLG(-1, LTE_FLG(F)), te_c(fa)), NULL),
...
T(cj) {
    ...
    V(RN(AN(TS(VD), LN(LT(3, "mc", FLG(-1, LTE_FLG(F)), te_c(fn), "cc", FLG(0, LTE_FLG(L)), te_c(cj), "e", FLG(1, LTE_FLG(L) | LTE_FLG(E)), TS(I6)), L(5,
...
T(leap) {
    ...
    V(RN(AN(TS(VD), LN(LT(2, "y", FLG(0, LTE_FLG(L)), TS(I6), "v", FLG(1, LTE_FLG(E) | LTE_FLG(L)), te_c(vt)), L(4,
        ...
        ON(TS(VD), LOOP, LN(NULL, L(1, ON(TS(BL), LTE, EN("y", FLG(0, LTE_FLG(L)), TS(I6)), SN(I6, I6(2030))))), LN(LT(2, "y", FLG(0, LTE_FLG(O) | LTE_FLG(L)), TS(I6), "v", FLG(0, LTE_FLG(O) | LTE_FLG(L) | LTE_FLG(E)), te_c(vt)), L(2,
            ON(TS(VD), IF,
                ...
                LN(NULL, L(1, ON(te_c(vt), CNCTA, EN("v", FLG(0, LTE_FLG(O) | LTE_FLG(L) | LTE_FLG(E)), te_c(vt)), EN("y", FLG(0, LTE_FLG(O) | LTE_FLG(L)), TS(I6)))))),
...
T(vrup) {
    ...
    V(RN(AN(TS(VD), LN(LT(2, "v", FLG(0, LTE_FLG(L)), te_c(vt), "f", FLG(-1, LTE_FLG(F)), te_c(ft)), L(3,
...
T(stll) {
    ...
    te *su = TH(ST, 2, "i", TS(I6), "n", te_c(uv));
    te *utt = TH(UN, 2, "y", TS(VD), "z", TRF(6));
    te *stt = TH(ST, 2, "i", TS(I6), "n", te_c(utt));
    te *fa = TFN(FN, TS(VD), 2, "x", te_c(stt), 0, "i", TS(I6), 1);
    te *fb = TFN(FN, TS(VD), 1, "x", te_c(stt), 0);
    V(RN(AN(TS(VD), LN(LT(4, "l", FLG(0, LTE_FLG(L) | LTE_FLG(E)), te_c(stt), "a", FLG(-1, LTE_FLG(F)), te_c(fa), "i", FLG(1, LTE_FLG(L)), TS(I6), "b", FLG(-2, LTE_FLG(F)), te_c(fb)), L(7,
        ON(te_c(stt), DFN, EN("l", FLG(0, LTE_FLG(L) | LTE_FLG(E)), te_c(stt)), ON(te_c(stt), CST,
            NN(T, te_c(stt)), ON(te_c(su), MTCH, LN(NULL, NULL), LN(NULL, L(2,
        ...
        ON(te_c(fa), DFN, EN("a", FLG(-1, LTE_FLG(F)), te_c(fa)), ON(te_c(fa), CST, NN(T, te_c(fa)),
            LN(LT(2, "i", FLG(1, LTE_FLG(A)), TS(I6), "x", FLG(0, LTE_FLG(A)), te_c(stt)), L(2,
                ON(TS(VD), DUMP, SN(U5, U5(1)), AN(TS(SG), CS("a: %ld"), L(1, EN("i", FLG(1, LTE_FLG(A)), TS(I6))))),
                ON(TS(VD), MTCH,
                    ...
                    LN(LT(4, "x", U6(0), NULL, "i", FLG(1, LTE_FLG(O) | LTE_FLG(A)), TS(I6), "a", U6(0), NULL, "z", FLG(-1, LTE_FLG(Y)), te_c(stt)), L(2,
                        ZTN("y", TS(_M), ON(te_c(stt), AGN,
                            ...
                            ON(te_c(stt), CST, EN("x", FLG(0, LTE_FLG(A)), te_c(stt)),
                            ON(te_c(su), MTCH, LN(NULL, NULL),
       ...
       ON(te_c(fb), DFN, EN("b", FLG(-2, LTE_FLG(F)), te_c(fb)), ON(te_c(fb), CST, NN(T, te_c(fb)),
            LN(LT(1, "x", FLG(0, LTE_FLG(A)), te_c(stt)), L(2,
                ON(TS(VD), DUMP, SN(U5, U5(1)), AN(TS(SG), CS("b: %ld"), L(1, ZTN("i", TS(I6),
                    EN("x", FLG(0, LTE_FLG(A)), te_c(stt)))))),
                ON(TS(VD), MTCH,
                    LN(NULL, L(1, ZTN("n", te_c(utt), EN("x", FLG(0, LTE_FLG(A)), te_c(stt))))),
                    LN(LT(2, "b", U6(0), NULL, "z", FLG(-2, LTE_FLG(Y)), te_c(stt)), L(1,
                        ZTN("z", TS(_M), AN(TS(VD), EN("b", FLG(-2, LTE_FLG(F)), te_c(fb)), L(1,
                            EN("z", FLG(-2, LTE_FLG(Y)), te_c(stt))
                        )))
                    )))
            )))),
...
T(validm) {
    ...
    te *wvi = type_cpy(vi);
    wvi->d[1].u4 = TYPE(WVR);
    te *tv = type_te_i_v(&al_te, NULL, 2, te_c(vi), te_c(vi));
    te *ee = chk_rt_err_t(&al_te);
    te *ev = TH(UN, 2, "e", te_c(ee), "v", te_c(wvi));
    te *tt = type_te_i_v(&al_te, NULL, 3, TS(I6), TS(I6), TS(I6));
    te *ue = TH(UN, 2,  "e", te_c(ee), "v", TS(VD));
    te *fn = TFN(FN, te_c(ue), 1, "x", te_c(vv), 0);
    V(RN(AN(TS(VD), LN(LT(3, "a", FLG(0, LTE_FLG(L)), te_c(vv), "b", FLG(1, LTE_FLG(L)), te_c(vv), "v", FLG(-1, LTE_FLG(F)), te_c(fn)), L(6,
        ON(te_c(vv), DFN, EN("a", FLG(0, LTE_FLG(L)), te_c(vv)), ON(te_c(vv), CST, NN(T, te_c(vv)), VN(te_c(tv), L(2,
            ON(te_c(vi), CST, NN(T, te_c(vi)), VN(te_c(tt), L(3, SN(I6, I6(1)), SN(I6, I6(2)), SN(I6, I6(3))))),
            ON(te_c(vi), CST, NN(T, te_c(vi)), VN(te_c(tt), L(3, SN(I6, I6(4)), SN(I6, I6(5)), SN(I6, I6(6)))))
        )))),
        ON(te_c(vv), DFN, EN("b", FLG(1, LTE_FLG(L)), te_c(vv)), ON(te_c(vv), CST, NN(T, te_c(vv)), VN(te_c(tv), L(2,
            ON(te_c(vi), CST, NN(T, te_c(vi)), VN(type_te_i_v(&al_te, NULL, 2, TS(I6), TS(I6)), L(2, SN(I6, I6(1)), SN(I6, I6(2))))),
            ON(te_c(vi), CST, NN(T, te_c(vi)), VN(type_te_i_v(&al_te, NULL, 1, TS(I6)), L(1, SN(I6, I6(4)))))
        )))),
        ON(te_c(fn), DFN, EN("v", FLG(-1, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)),
            LN(LT(4, "l", FLG(0, LTE_FLG(L)), TS(U6), "x", FLG(0, LTE_FLG(A)), te_c(vv), "t", FLG(1, LTE_FLG(L)), TS(U6), "i", FLG(2, LTE_FLG(L)), TS(U6)), L(5,
                ON(TS(VD), IF,
                    LN(NULL, L(1, ON(TS(BL), EQ,
                        ON(TS(U6), DFN, EN("l", FLG(0, LTE_FLG(L)), TS(U6)), ON(TS(U6), DIV, NULL, EN("x", FLG(0, LTE_FLG(A)), te_c(vv)))),
                        SN(U6, U6(0))))),
                    LN(NULL, L(1, ON(TS(VD), UNER, NULL, ON(TS(SG), CSG, NULL, CS("Empty")))))),
                ON(TS(U6), DFN, EN("t", FLG(1, LTE_FLG(L)), TS(U6)), ON(TS(U6), DIV, NULL,
                    ZTN("v", te_c(wvi), AN(te_c(ev), EN("x", FLG(0, LTE_FLG(A)), te_c(vv)), L(1, SN(I6, I6(0))))))),
                ON(TS(U6), DFN, EN("i", FLG(2, LTE_FLG(L)), TS(U6)), ON(TS(U6), CST, TN(U6), SN(I6, I6(1)))),
                ON(TS(VD), LOOP,
                    LN(NULL, L(1,
                        ON(TS(BL), LT, EN("i", FLG(2, LTE_FLG(L)), TS(U6)), EN("l", FLG(0, LTE_FLG(L)), TS(U6)))
                    )),
                    LN(NULL, L(2,
                        ON(TS(VD), IF,
                            LN(NULL, L(1, ON(TS(BL), NE, EN("t", FLG(1, LTE_FLG(L)), TS(U6)),
                                ON(TS(U6), DIV, NULL, ZTN("v", te_c(wvi),
                                    AN(te_c(ev), EN("x", FLG(0, LTE_FLG(A)), te_c(vv)),
                                        L(1, EN("i", FLG(2, LTE_FLG(L)), TS(U6))))))))),
                            LN(NULL, L(1, ON(TS(VD), UNER, NULL, ON(TS(SG), CSG, NULL, CS("Inv")))))),
                        ON(TS(U6), ADDA, EN("i", FLG(2, LTE_FLG(L)), TS(U6)), SN(U6, U6(1)))
                    ))),
                ZTN("v", TH(UN, 1, "v", TS(VD)), NULL)
            )))),
...
T(fndiv) {
    ...
    V(RN(AN(TS(VD), LN(LT(1, "f", FLG(-1, LTE_FLG(F)), te_c(fn)), L(3,
...
T(uperr) {
    ...
    V(RN(AN(TS(VD), LN(LT(1, "x", FLG(0, LTE_FLG(L)), TS(SG)), L(2,
...
T(movep) {
    ...
    IC(TPGM(movep));
    V(RN(AN(TS(VD), LN(LT(3, "x", FLG(0, LTE_FLG(L) | LTE_FLG(M)), te_c(tf), "y", FLG(1, LTE_FLG(L) | LTE_FLG(M)), te_c(ti), "s", FLG(2, LTE_FLG(E) | LTE_FLG(L)), te_c(ts)), L(4,
        ON(te_c(tf), DFN, EN("x", FLG(0, LTE_FLG(M) | LTE_FLG(L)), te_c(tf)),
            VN(te_c(tf), L(2, SN(F6, F6(1.1)), SN(F6, F6(2.2))))),
        ON(te_c(ti), DFN, EN("y", FLG(1, LTE_FLG(M) | LTE_FLG(L)), te_c(ti)),
            VN(te_c(ti), L(2, SN(I6, I6(3)), SN(I6, I6(4))))),
        ON(te_c(ts), DFN, EN("s", FLG(2, LTE_FLG(E) | LTE_FLG(L)), te_c(ts)), ON(te_c(ts), MTCH, LN(NULL, NULL),
            LN(LT(2, "x", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(tf), "y", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(ti)), L(2,
                ZTN("x", TS(VD), EN("x", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(tf))),
                ZTN("y", TS(VD), EN("y", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(ti)))
            )))),
        ON(TS(VD), DUMP, SN(U5, U5(1)), EN("s", FLG(2, LTE_FLG(E) | LTE_FLG(L)), te_c(ts)))
    )), NULL)));
    te_f(tf);
    te_f(ti);
    te_f(ts);
...
T(mmut) {
    ...
    IC(TPGM(mmut));
    V(RN(AN(TS(VD), LN(LT(2, "a", FLG(0, LTE_FLG(L)), te_c(ut), "b", FLG(1, LTE_FLG(L) | LTE_FLG(E)), te_c(ut)), L(6,
        ON(te_c(ut), DFN, EN("a", FLG(0, LTE_FLG(L)), te_c(ut)),
            ZTN("s", TS(VD), ON(te_c(vt), CST, NN(T, te_c(vt)), VN(TS(TE), L0())))),
        ON(te_c(wvt), CNCTA, ZTN("s", te_c(wvt), EN("a", FLG(0, LTE_FLG(L)), te_c(ut))), SN(I6, I6(1))),
        ON(te_c(ut), DFN,
            EN("b", FLG(1, LTE_FLG(L) | LTE_FLG(E)), te_c(ut)),
            EN("a", FLG(0, LTE_FLG(L)), te_c(ut))),
        ON(te_c(wvt), CNCTA, ZTN("s", te_c(wvt), EN("b", FLG(1, LTE_FLG(L) | LTE_FLG(E)), te_c(ut))), SN(I6, I6(2))),
...
T(cjvr) {
    ...
    V(RN(AN(TS(VD), LN(LT(3, "f", FLG(-1, LTE_FLG(F)), te_c(fn), "c", FLG(0, LTE_FLG(L)), te_c(cj), "e", FLG(1, LTE_FLG(E) | LTE_FLG(L)), TS(U6)), L(4,
        ON(te_c(fn), DFN, EN("f", FLG(-1, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)), LN(LT(2, "v", FLG(0, LTE_FLG(M) | LTE_FLG(L)), te_c(vv), "-1", FLG(-2, LTE_FLG(F)), te_c(nf)), L(2,
            ON(te_c(vv), DFN, EN("v", FLG(0, LTE_FLG(M) | LTE_FLG(L)), te_c(vv)), ON(te_c(vv), CST, NN(T, TV(VR, TS(U6))), VN(TS(TE), L0()))),
            ON(te_c(cj), CST, NN(T, te_c(cj)), ON(te_c(nf), DFN, EN("-1", FLG(-2, LTE_FLG(F)), te_c(nf)), ON(te_c(nf), CST, NN(T, te_c(nf)),
                LN(LT(4, "v", FLG(0, LTE_FLG(S)), te_c(vv), "x", FLG(0, LTE_FLG(A)), TS(U6), "s", FLG(0, LTE_FLG(L)), TS(U6), "i", FLG(1, LTE_FLG(L)), TS(U6)), L(6,
                    ON(te_c(vv), CNCTA, EN("v", FLG(0, LTE_FLG(S)), te_c(vv)), EN("x", FLG(0, LTE_FLG(A)), TS(U6))),
                    ON(TS(VD), DUMP, SN(U5, U5(1)), EN("v", FLG(0, LTE_FLG(S)), te_c(vv))),
                    ON(TS(U6), DFN, EN("s", FLG(0, LTE_FLG(L)), TS(U6)), ON(TS(U6), CST, TN(U6), SN(I6, I6(0)))),
                    ON(TS(U6), DFN, EN("i", FLG(1, LTE_FLG(L)), TS(U6)), ON(TS(U6), CST, TN(U6), SN(I6, I6(0)))),
                    ON(TS(VD), LOOP,
                        LN(NULL, L(1,
                            ON(TS(BL), LT, EN("i", FLG(1, LTE_FLG(L)), TS(U6)), ON(TS(U6), DIV, NULL, EN("v", FLG(0, LTE_FLG(S)), te_c(vv)))))),
                        LN(NULL, L(2,
                            ON(TS(U6), ADDA, EN("s", FLG(0, LTE_FLG(L)), TS(U6)), ON(TS(U6), UNER, NULL,
                                AN(te_c(eu), EN("v", FLG(0, LTE_FLG(S)), te_c(vv)), L(1, EN("i", FLG(1, LTE_FLG(L)), TS(U6)))))),
                            ON(TS(U6), ADDA, EN("i", FLG(1, LTE_FLG(L)), TS(U6)), SN(U6, U6(1)))
                        ))),
                    ZTN("v", te_c(eu), EN("s", FLG(0, LTE_FLG(L)), TS(U6)))
                ))
        ))))))),
        ON(te_c(cj), DFN, EN("c", FLG(0, LTE_FLG(L)), te_c(cj)), AN(te_c(cj), EN("f", FLG(-1, LTE_FLG(F)), te_c(fn)), NULL)),
        AN(te_c(eu), EN("c", FLG(0, LTE_FLG(L)), te_c(cj)), L(1, ON(TS(U6), CST, TN(U6), SN(I6, I6(5))))),
        ON(TS(VD), DUMP, SN(U5, U5(1)), ON(TS(U6), DFN, EN("e", FLG(1, LTE_FLG(E) | LTE_FLG(L)), TS(U6)),
            ON(TS(U6), UNER, NULL, AN(te_c(eu), EN("c", FLG(0, LTE_FLG(L)), te_c(cj)),
                L(1, ON(TS(U6), CST, TN(U6), SN(I6, I6(6))))))))
    )), NULL)));
    te_f(ee);
    te_f(eu);
    te_f(vv);
...
T(mapstrs) {
    ...
    V(RN(AN(TS(VD), LN(LT(3, "v", FLG(0, LTE_FLG(L)), te_c(vv), "m", FLG(1, LTE_FLG(E) | LTE_FLG(L)), te_c(vv), "-1", FLG(-1, LTE_FLG(F)), te_c(fv)), L(3,
        ...
        ON(te_c(vv), DFN, EN("m", FLG(1, LTE_FLG(E) | LTE_FLG(L)), te_c(vv)), ON(te_c(vv), MUL,
