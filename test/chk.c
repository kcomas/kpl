...
T(apltypefn) {
    ...
    V(RN(AN(TS(VD), LN(LT(1, "f", FLG(0, LTE_FLG(F)), te_c(ft)), L(2,
        ON(te_c(ft), DFN, EN("f", FLG(0, LTE_FLG(F)), te_c(ft)), ON(te_c(ft), CST, NN(T, te_c(ft)), LN(LT(2, "a", FLG(0, LTE_FLG(A)), TS(I6), "b", FLG(1, LTE_FLG(A)), TS(I6)), L(1, ON(TS(I6), ADD, EN("a", FLG(0, LTE_FLG(A)), TS(I6)), ON(TS(I6), MUL, EN("b", FLG(1, LTE_FLG(A)), TS(I6)), EN("a", FLG(0, LTE_FLG(A)), TS(I6)))))))),
...
T(facloop) {
    ...
    V(RN(AN(TS(VD), LN(LT(2, "v", FLG(0, LTE_FLG(L)), TS(I6), "f", FLG(1, LTE_FLG(E) | LTE_FLG(L)), TS(I6)), L(4,
        ...
        ON(TS(VD), LOOP,
            ON(TS(BL), GT, EN("v", FLG(0, LTE_FLG(L)), TS(I6)), SN(I6, I6(1))),
            LN(LT(2, "f", FLG(0, LTE_FLG(O)), TS(I6), "v", FLG(0, LTE_FLG(O)), TS(I6)), L(2,
                ON(TS(I6), MULA, EN("f", FLG(0, LTE_FLG(O)), TS(I6)), EN("v", FLG(0, LTE_FLG(O)), TS(I6))),
                ON(TS(I6), SUBA, EN("v", FLG(0, LTE_FLG(O)), TS(I6)), SN(I6, I6(1)))))),
