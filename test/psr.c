...
T(stll) {
    ...
    V(h, {N(ROOT), APLY(LST(
        ...
        OP(N(VAR), OP(APLY(N(TYPE), SYM(CMD(N(VAR))), SYM(N(TYPE)), N(TYPE)), LST(
            ...
            OP(SYM(N(VAR)), LST(
                SYM(APLY(OP(N(NONE), N(NONE)), SYM(SYM(N(VAR))), OP(N(VAR),
                    OP(N(NONE), LST(SYM(N(VAR)), SYM(SYM(N(NONE)))))
                ))),
                SYM(APLY(N(VAR), N(VAR), N(VAR)))
            ))
        ))),
        OP(N(VAR), N(INT)),
...
T(movep) {
    te *h = ppnode(psr_r(bpsr(TPGM(movep))));
    V(h, {N(ROOT), APLY(LST(
...
T(impst) {
    ...
    V(h, {N(ROOT), APLY(LST(
        OP(N(VAR), CMD(N(STR))),
        CMD(SYM(SYM(N(VAR)))),
        OP(CMD(N(VAR)), OP(APLY(SYM(SYM(N(VAR))), N(INT)), APLY(SYM(SYM(N(VAR))), N(INT))))
    ))});
    te_f(h);
}
...
T(cjvr) {
    te *h = ppnode(psr_r(bpsr(TPGM(cjvr))));
    V(h, {N(ROOT), APLY(LST(
        OP(N(VAR), OP(N(TYPE), LST(
            OP(N(VAR), OP(APLY(N(TYPE), N(TYPE)), N(VEC))),
            OP(N(TYPE), OP(APLY(N(TYPE), SYM(N(TYPE)), N(KEY)), LST(
                OP(N(VAR), N(VAR)),
                CMD(N(VAR)),
...
T(mapstrs) {
    ...
    V(h, {N(ROOT), APLY(LST(
        ...
        OP(CMD(N(VAR)),OP(APLY(OP(N(NONE), N(NONE)), N(TYPE), LST(OP(N(STR), APLY(N(TYPE), N(VAR))))), N(VAR))),
        CMD(N(VAR))
    ))});
    te_f(h);
}
