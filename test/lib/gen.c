...
static gen *init(void) {
    gen *g = gen_i(&malloc, &free, &gen_entry_f, &gen_code_entry_f, &gen_cls_info_tbl, gen_op_tbl(GEN_OP(_END)), gen_mklst());
    gen_b(g);
    return g;
}
...
void fibtest(void) {
    ...
    A(gen_a(g, GEN_OP(GT), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U6), U6(2)), gen_lbl(2)));
...
void acktest(void) {
    ...
    // m == 0
    A(gen_a(g, GEN_OP(NE), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U6), U6(0)), gen_lbl(1)));
    A(gen_a(g, GEN_OP(ADD), gen_tmp(X64_TYPE(U6), 0), gen_arg(X64_TYPE(U6), 1), gen_data(X64_TYPE(U3), U3(1))));
    A(gen_a(g, GEN_OP(LEAVE), gen_tmp(X64_TYPE(U6), 0), NULL, NULL));
    // m > 0 && n == 0
    A(gen_a(g, GEN_OP(LBL), gen_lbl(1), NULL, NULL));
    A(gen_a(g, GEN_OP(EQ), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U6), U6(0)), gen_lbl(2)));
    A(gen_a(g, GEN_OP(NE), gen_arg(X64_TYPE(U6), 1), gen_data(X64_TYPE(U6), U6(0)), gen_lbl(2)));
    A(gen_a(g, GEN_OP(SUB), gen_tmp(X64_TYPE(U6), 0), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U3), U3(1))));
    // call ack(m - 1, 1)
    A(gen_a(g, GEN_OP(CALL), gen_tmp(X64_TYPE(U6), 0), gen_call_m(2, gen_tmp(X64_TYPE(U6), 0), gen_data(X64_TYPE(U6), U6(1))), gen_lbl(0)));
    A(gen_a(g, GEN_OP(LEAVE), gen_tmp(X64_TYPE(U6), 0), NULL, NULL));
    // m > 0 && n > 0
    A(gen_a(g, GEN_OP(LBL), gen_lbl(2), NULL, NULL));
    A(gen_a(g, GEN_OP(EQ), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U6), U6(0)), gen_lbl(3)));
    A(gen_a(g, GEN_OP(EQ), gen_arg(X64_TYPE(U6), 1), gen_data(X64_TYPE(U6), U6(0)), gen_lbl(3)));
    // call ack(m - 1, ack(m, n - 1))
    A(gen_a(g, GEN_OP(SUB), gen_tmp(X64_TYPE(U6), 1), gen_arg(X64_TYPE(U6), 1), gen_data(X64_TYPE(U3), U3(1))));
    A(gen_a(g, GEN_OP(CALL), gen_tmp(X64_TYPE(U6), 1), gen_call_m(2, gen_arg(X64_TYPE(U6), 0), gen_tmp(X64_TYPE(U6), 1)), gen_lbl(0)));
    A(gen_a(g, GEN_OP(SUB), gen_tmp(X64_TYPE(U6), 2), gen_arg(X64_TYPE(U6), 0), gen_data(X64_TYPE(U3), U3(1))));
    A(gen_a(g, GEN_OP(CALL), gen_tmp(X64_TYPE(U6), 2), gen_call_m(2, gen_tmp(X64_TYPE(U6), 2), gen_tmp(X64_TYPE(U6), 1)), gen_lbl(0)));
    A(gen_a(g, GEN_OP(LEAVE), gen_tmp(X64_TYPE(U6), 2), NULL, NULL));
    // else
    A(gen_a(g, GEN_OP(LBL), gen_lbl(3), NULL, NULL));
    A(gen_a(g, GEN_OP(ADD), gen_tmp(X64_TYPE(U6), 3), gen_arg(X64_TYPE(U6), 1), gen_data(X64_TYPE(U3), U3(1))));
    A(gen_a(g, GEN_OP(LEAVE), gen_tmp(X64_TYPE(U6), 3), NULL, NULL));
