...
TEST(x64_dis_mov_add_ret) {
    ...
    ASSERT(x64_check_error(&state, dis_check_mne(&state, DEF_STATIC_ARRAY_SIZE(byte_check_array), byte_check_array,
        DEF_STATIC_ARRAY_SIZE(mne_array), mne_array)), "x64 invalid dis");
