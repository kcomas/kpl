...
T(stll) {
    ...
    V(RN(LN(LT(4, "l", FLG(0, LTE_FLG(L) | LTE_FLG(E)), te_c(stt), "a", FLG(-1, LTE_FLG(F)), te_c(fa), "i", FLG(1, LTE_FLG(L)), TS(I6), "b", FLG(-2, LTE_FLG(F)), te_c(fb)), L(7,
       ...
       ON(te_c(fb), DFN, EN("b", FLG(-2, LTE_FLG(F)), te_c(fb)), ON(te_c(fb), CST, NN(T, te_c(fb)),
            LN(LT(2, "x", FLG(0, LTE_FLG(A)), te_c(stt), "1", FLG(0, LTE_FLG(L)), TS(SG)), L(2,
                ON(TS(VD), DUMP, SN(U5, U5(1)), ON(TS(SG), DFN, EN("1", FLG(0, LTE_FLG(L)), TS(SG)),
                    AN(TS(SG), CS("b: %ld"), L(1, ZTN("i", TS(I6),
...
T(validm) {
    ...
    V(RN(LN(LT(3, "a", FLG(0, LTE_FLG(L)), te_c(vv), "b", FLG(1, LTE_FLG(L)), te_c(vv), "v", FLG(-1, LTE_FLG(F)), te_c(fn)), L(6,
        ...
        ON(te_c(fn), DFN, EN("v", FLG(-1, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)),
            LN(
                LT(6, "l", FLG(0, LTE_FLG(L)), TS(U6), "x", FLG(0, LTE_FLG(A)), te_c(vv),
                    "t", FLG(1, LTE_FLG(L)), TS(U6), "i", FLG(2, LTE_FLG(L)), TS(U6),
                    "0", FLG(3, LTE_FLG(L)), te_c(ev), "1", FLG(4, LTE_FLG(L)), te_c(ev)),
                L(5,
                    ON(TS(VD), IF,
                    ...
                    ON(TS(U6), DFN, EN("t", FLG(1, LTE_FLG(L)), TS(U6)), ON(TS(U6), DIV, NULL,
                        ZTN("v", te_c(vi), ON(te_c(ev), DFN, EN("0", FLG(3, LTE_FLG(L)), te_c(ev)), AN(te_c(ev),
                            EN("x", FLG(0, LTE_FLG(A)), te_c(vv)), L(1, SN(I6, I6(0)))))))),
                    ON(TS(U6), DFN, EN("i", FLG(2, LTE_FLG(L)), TS(U6)), SN(U6, U6(1))),
                    ON(TS(VD), LOOP,
                        LN(NULL, L(1,
                        ...
                        LN(NULL, L(2,
                            ON(TS(VD), IF,
                                LN(NULL, L(1, ON(TS(BL), NE, EN("t", FLG(1, LTE_FLG(L)), TS(U6)),
                                    ON(TS(U6), DIV, NULL, ZTN("v", te_c(vi),
                                        ON(te_c(ev), DFN, EN("1", FLG(4, LTE_FLG(L)), te_c(ev)), AN(te_c(ev), EN("x", FLG(0, LTE_FLG(A)), te_c(vv)),
...
T(movep) {
    ...
    IC(TPGM(movep));
    V(RN(LN(LT(3, "x", FLG(0, LTE_FLG(L) | LTE_FLG(M)), te_c(tf), "y", FLG(1, LTE_FLG(L) | LTE_FLG(M)), te_c(ti), "s", FLG(2, LTE_FLG(E) | LTE_FLG(L)), te_c(ts)), L(4,
        ...
        ON(te_c(ts), DFN, EN("s", FLG(2, LTE_FLG(E) | LTE_FLG(L)), te_c(ts)), ON(te_c(ts), MTCH, LN(NULL, NULL),
            LN(LT(2, "x", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(tf), "y", FLG(1, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(ti)), L(2,
                ZTN("x", TS(VD), EN("x", FLG(0, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(tf))),
                ZTN("y", TS(VD), EN("y", FLG(1, LTE_FLG(M) | LTE_FLG(O) | LTE_FLG(L)), te_c(ti)))
            )))),
...
T(impst) {
    ...
    V(RN(LN(LT(1, "r", FLG(0, LTE_FLG(L) | LTE_FLG(E)), TS(I6)), L(3,
        ...
        ON(TS(I6), DFN, EN("r", FLG(0, LTE_FLG(L) | LTE_FLG(E)), TS(I6)), SN(I6, I6(7)))
    ))));
    te_f(tf);
    te_f(ti);
    te_f(ts);
...
T(cjvr) {
    ...
    V(RN(LN(LT(4, "f", FLG(-1, LTE_FLG(F)), te_c(fn), "c", FLG(0, LTE_FLG(L)), te_c(cj), "e", FLG(1, LTE_FLG(E) | LTE_FLG(L)), TS(U6), "0", FLG(2, LTE_FLG(L)), te_c(eu)), L(4,
        ON(te_c(fn), DFN, EN("f", FLG(-1, LTE_FLG(F)), te_c(fn)), ON(te_c(fn), CST, NN(T, te_c(fn)), LN(LT(2, "v", FLG(0, LTE_FLG(M) | LTE_FLG(L)), te_c(vv), "-1", FLG(-2, LTE_FLG(F)), te_c(nf)), L(2,
            ...
            ON(te_c(cj), CST, NN(T, te_c(cj)), ON(te_c(nf), DFN, EN("-1", FLG(-2, LTE_FLG(F)), te_c(nf)), ON(te_c(nf), CST, NN(T, te_c(nf)),
                LN(LT(4, "v", FLG(0, LTE_FLG(S)), te_c(vv), "x", FLG(0, LTE_FLG(A)), TS(U6), "s", FLG(0, LTE_FLG(L)), TS(U6), "i", FLG(1, LTE_FLG(L)), TS(U6)), L(6,
                    ...
                    ON(TS(U6), DFN, EN("s", FLG(0, LTE_FLG(L)), TS(U6)), SN(U6, U6(0))),
                    ON(TS(U6), DFN, EN("i", FLG(1, LTE_FLG(L)), TS(U6)), SN(U6, U6(0))),
                    ON(TS(VD), LOOP,
                        LN(NULL, L(1,
...
T(args) {
    IC(TPGM(args));
    te *vv = TV(VR, TS(SG));
    V(RN(LN(LT(1, "a", FLG(0, LTE_FLG(L) | LTE_FLG(E)), te_c(vv)), L(1,
        ON(TS(VD), DUMP, SN(U5, U5(1)),
...
T(mapstrs) {
    ...
    V(RN(LN(LT(3, "v", FLG(0, LTE_FLG(L)), te_c(vv), "m", FLG(1, LTE_FLG(E) | LTE_FLG(L)), te_c(vv), "-1", FLG(-1, LTE_FLG(F)), te_c(fv)), L(3,
        ON(te_c(vv), DFN, EN("v", FLG(0, LTE_FLG(L)), te_c(vv)), VN(te_c(vv), L(2,
        ...
        ON(te_c(vv), DFN, EN("m", FLG(1, LTE_FLG(E) | LTE_FLG(L)), te_c(vv)), ON(te_c(vv), MUL,
            ON(te_c(fv), DFN, EN("-1", FLG(-1, LTE_FLG(F)), te_c(fv)), ON(te_c(fv), CST, NN(T, te_c(fv)),
                LN(LT(2, "x", FLG(0, LTE_FLG(A)), TS(SG), "0", FLG(0, LTE_FLG(L)), TS(SG)),
                    L(1, ON(TS(SG), CNCT, ON(TS(SG), DFN, EN("0", FLG(0, LTE_FLG(L)), TS(SG)),
                        ON(TS(SG), CSG, NULL, CS("_"))), EN("x", FLG(0, LTE_FLG(A)), TS(SG))))))),
...
T(retest) {
    ...
    V(RN(LN(LT(6, "r", FLG(-1, LTE_FLG(F)), te_c(rt), "t", FLG(0, LTE_FLG(E) | LTE_FLG(L)), te_c(tt), "0", FLG(1, LTE_FLG(L)), TS(SG), "1", FLG(2, LTE_FLG(L)), TS(SG), "2", FLG(3, LTE_FLG(L)), TS(SG), "3", FLG(4, LTE_FLG(L)), TS(SG)), L(3,
        ON(te_c(rt), DFN, te_c(re), REGX(te_c(rt), -1, REGX_MODE(T), REGX_FLG(I), "^a.$", NULL)),
        ON(te_c(tt), DFN, te_c(et), VN(te_c(tt), L(4,
            AN(TS(BL), te_c(re), L(1, ON(TS(SG), DFN, EN("0", FLG(1, LTE_FLG(L)), TS(SG)), ON(TS(SG), CSG, NULL, CS("ab"))))),
            AN(TS(BL), te_c(re), L(1, ON(TS(SG), DFN, EN("1", FLG(2, LTE_FLG(L)), TS(SG)), ON(TS(SG), CSG, NULL, CS("Ab"))))),
            AN(TS(BL), te_c(re), L(1, ON(TS(SG), DFN, EN("2", FLG(3, LTE_FLG(L)), TS(SG)), ON(TS(SG), CSG, NULL, CS("abc"))))),
            AN(TS(BL), te_c(re), L(1, ON(TS(SG), DFN, EN("3", FLG(4, LTE_FLG(L)), TS(SG)), ON(TS(SG), CSG, NULL, CS("a")))))
        ))),
