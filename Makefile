...
OPT = opt$(TNAME)
OPT_OBJS = $(SRC)/opt.o $(LSRC)/opt.o $(CHK_OBJS)
OBJS += $(OPT_OBJS)
$(OPT): $(OPT_OBJS) $(TEST)/opt.o $(TEST)/fld_t.o $(TEST)/ast_t.o $(TEST)/psr_t.o $(TEST_OBJS)
> $(CCOBJ)

AG = ag$(TNAME)
AG_OBJS = $(LSRC)/ag.o $(OPT_OBJS) $(GEN_OBJS)
AGX64_OBJS = $(SRC)/ag_x64.o $(GENX64_OBJS)
OBJS += $(AG_OBJS) $(AGX64_OBJS)
$(AG): $(AG_OBJS) $(AGX64_OBJS) $(TEST)/ag.o $(TEST)/gen_t.o $(TEST)/as_t.o $(TEST_OBJS) $(TEST)/fld_t.o $(TEST)/ast_t.o $(TEST)/psr_t.o $(TEST_OBJS)
> $(CCOBJ)
