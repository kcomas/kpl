...
static ast_stat add_lst(ast *a, te *restrict pn, te **an, err **e) {
    ast_stat stat;
    void *ln;
...
static ast_stat ast_vec(ast *a, te *restrict pan, te *restrict pn, void **vn, err **e) {
    te **an = (te**) vn;
    *an = ast_an_i(a, pan, pn, AST_CLS(V), P(NULL), NULL);
    return add_lst(a, pn, an, e);
}
