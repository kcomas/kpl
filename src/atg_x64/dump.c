...
static atg_stat dump_vr(atg *t, gen *g, te *restrict an, err **e, FILE *f, uint32_t idnt, te *restrict type, te *restrict cd) {
    ...
    dump_idnt(g, &v, idnt);
    if (gen_a(g, GEN_OP(CALLV), gen_call_v(g, v), gen_data(g, X64_TYPE(M), P(fprintf)), NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
    if (gen_a(g, GEN_OP(EQ), gen_idx_m(g, X64_TYPE(U6), 2, te_c(cd), gen_data(g, X64_TYPE(U3), U3(offsetof(vr, l)))), gen_data(g, X64_TYPE(U6), U6(0)), gen_lbl(g, el)) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
    ...
    if ((stat = dump_v(t, g, an, e, f, idnt + 1, type, gen_idx_m(g, type_g_x64_type(type), 3, te_c(cd), gen_data(g, X64_TYPE(U3), U3(offsetof(vr, d))), gen_tmp(g, X64_TYPE(U6), tv)), true)) != ATG_STAT(OK)) return stat;
    ...
    if (gen_a(g, GEN_OP(LT), gen_tmp(g, X64_TYPE(U6), tv), gen_idx_m(g, X64_TYPE(U6), 2, te_c(cd), gen_data(g, X64_TYPE(U3), U3(offsetof(vr, l)))), gen_lbl(g, tl)) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
...
static atg_stat dump_un(atg *t, gen *g, te *restrict an, err **e, FILE *f, uint32_t idnt, te *restrict type, te *restrict cd) {
    ...
    while (h) {
        ...
        x64_type xt = type_g_x64_type(((te*) h->d[0].p)->d[2].p);
        ud = xt != X64_TYPE(N) ? gen_idx_m(g, xt, 2, te_c(cd), atg_te_idx_d(g, 1)) : NULL;
        if ((stat = dump_v(t, g, an, e, f, idnt + 1, ((te*) h->d[0].p)->d[2].p, ud, false)) != ATG_STAT(OK)) return stat;
...
static atg_stat dump_v(atg *t, gen *g, te *restrict an, err **e, FILE *f, uint32_t idnt, te *restrict type, te *restrict cd, bool nl) {
    ...
    switch (type->d[1].u4) {
        ...
        case TYPE(WTE):
            ti = t->tc++;
            if (type->d[1].u4 == TYPE(WTE)) {
                if (gen_a(g, GEN_OP(DREF), gen_tmp(g, X64_TYPE(M), ti), cd, NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
            } else if (gen_a(g, GEN_OP(SET), gen_tmp(g, X64_TYPE(M), ti), cd, NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
        ...
        case TYPE(WVR):
            ti = t->tc++;
            if (type->d[1].u4 == TYPE(WVR)) {
                if (gen_a(g, GEN_OP(DREF), gen_tmp(g, X64_TYPE(M), ti), cd, NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
            } else if (gen_a(g, GEN_OP(SET), gen_tmp(g, X64_TYPE(M), ti), cd, NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
            tetmp = gen_tmp(g, X64_TYPE(M), ti);
            if ((stat = dump_vr(t, g, an, e, f, idnt, type, tetmp)) != ATG_STAT(OK)) return stat;
            te_f(tetmp);
            break;
        case TYPE(UN):
    ...
    if (nl && gen_a(g, GEN_OP(CALLV), gen_call_m(g, 2, gen_data(g, X64_TYPE(M), P(f)), gen_data(g, X64_TYPE(M), P(atg_dump_nl))), gen_data(g, X64_TYPE(M), P(fprintf)), NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
    return stat;
}
...
static atg_stat dump_vd_s_u5_e_u6(atg *t, gen *g, te *an, err **e) {
    return dump_vd(t, g, an, e, var_arg(g, ((te*) an->d[6].p)->d[3].p, X64_TYPE(U6)));
}
...
static atg_stat dump_vd_s_u5__vr(atg *t, gen *g, te *restrict an, err **e, te *restrict ci) {
    atg_stat stat = ATG_STAT(OK);
    uint32_t idnt = 0;
    FILE *f = NULL;
    te *type;
    if ((stat = dump_g_fd(t, an, e, &f)) != ATG_STAT(OK)) return stat;
    if (ast_g_t(an->d[6].p, &type) != AST_STAT(OK)) return atg_err(t, an, e, "atg ast_g_t");
    if ((stat = dump_vr(t, g, an, e, f, idnt, type, ci)) != ATG_STAT(OK)) return stat;
    te_f(ci);
    if (gen_a(g, GEN_OP(CALLV), gen_call_m(g, 2, gen_data(g, X64_TYPE(M), P(f)), gen_data(g, X64_TYPE(M), P(atg_dump_nl))), gen_data(g, X64_TYPE(M), P(fprintf)), NULL) != GEN_STAT(OK)) return atg_err(t, an, e, __FUNCTION__);
    return stat;
}
...
static atg_stat dump_vd_s_u5_e_vr(atg *t, gen *g, te *an, err **e) {
    ...
    return dump_vd_s_u5__vr(t, g, an, e, var_arg(g, lte, X64_TYPE(M)));
}

static atg_stat dump_vd_s_u5_oa_vr(atg *t, gen *g, te *an, err **e) {
    return dump_vd_s_u5__vr(t, g, an, e, te_c(atg_g_g(an->d[6].p)->d[1].p));
}
...
static atg_stat dump_s(atg *t, gen *g, te *restrict an, err **e, const te *restrict type, un d) {
    atg_stat stat;
    FILE *f = NULL;
    if ((stat = dump_g_fd(t, an, e, &f)) != ATG_STAT(OK)) return stat;
    return dump_f_s(t, g, an, e, f, 0, type, d);
}

static atg_stat dump_vd_s_u5_s_te(atg *t, gen *g, te *an, err **e) {
    te *tn = an->d[6].p;
    return dump_s(t, g, an, e, tn->d[3].p, tn->d[4]);
}
...
void atg_dump(atg *t) {
    ...
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(E), TYPE(U6), dump_vd_s_u5_e_u6);
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(O), TYPE(I6), dump_vd_s_u5_oa_);
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(O), TYPE(U6), dump_vd_s_u5_oa_);
    ...
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(A), TYPE(WSG), dump_vd_s_u5_oa_);
    ...
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(O), TYPE(VR), dump_vd_s_u5_oa_vr);
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(A), TYPE(VR), dump_vd_s_u5_oa_vr);
    ...
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(Z), TYPE(WSG), dump_vd_s_u5_z);
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(Z), TYPE(WVR), dump_vd_s_u5_z);
    atg_a_o(t, OC(DUMP), TYPE(VD), AST_CLS(S), TYPE(U5), AST_CLS(S), TYPE(TE), dump_vd_s_u5_s_te);
}
