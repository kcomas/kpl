...
void as_rx_b(as *a) {
    ...
    as_op_a(a, AS_X64(ADDSD), ARG_ID(X), ARG_ID(RM), ARG_ID(N), ARG_ID(N), as_addsd_xrm, NULL);
    as_op_a(a, AS_X64(ADDSD), ARG_ID(X), ARG_ID(RM), ARG_ID(B), ARG_ID(N), as_addsd_xrmb, NULL);
