...
static gen_stat set_iu_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if ((stat = idx_to(g, s, ci, a, e, AS_X64(MOV), i, as_arg_i(a, ARG_ID(R), kv->d[2]), R(AX))) != GEN_STAT(OK)) return stat;
    drop_atm_kv(s, kv, ci);
    return GEN_STAT(OK);
}
...
static gen_stat set_iv_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if ((stat = idx_to(g, s, ci, a, e, AS_X64(MOV), i, as_arg_i(a, ARG_ID(R), U3(R(AX))), R(AX))) != GEN_STAT(OK)) return stat;
    return GEN_STAT(OK);
}
...
static gen_stat set_id_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if ((stat = idx_to(g, s, ci, a, e, AS_X64(MOV), i, as_arg_i(a, aid, ((te*) ci->d[2].p)->d[1]), R(AX))) != GEN_STAT(OK)) return stat;
    return GEN_STAT(OK);
}
...
static gen_stat set_ui_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if ((stat = idx_from(g, s, ci, a, e, AS_X64(MOV), i, as_arg_i(a, ARG_ID(R), kv->d[2]), R(AX))) != GEN_STAT(OK)) return stat;
    drop_atm_kv(s, kv, ci);
    return GEN_STAT(OK);
}
...
void gen_set(gen *g) {
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(I), X64_TYPE(N), GEN_CLS(V), X64_TYPE(I6), set_iv_fn);
