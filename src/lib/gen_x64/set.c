...
static gen_stat set_ii_fn(gen *g, void *s, te *ci, as *a, err **e) {
    gen_stat stat;
    vr *to = ((te*) ci->d[1].p)->d[1].p, *from = ((te*) ci->d[2].p)->d[1].p;
    if ((stat = idx_from(g, s, ci, a, e, AS_X64(MOV), from, as_arg_i(a, ARG_ID(R), U3(R(AX))), R(DX), ARG_ID(R))) != GEN_STAT(OK)) return stat;
    if ((stat = idx_to(g, s, ci, a, e, AS_X64(MOV), to, as_arg_i(a, ARG_ID(R), U3(R(AX))), R(DX), ARG_ID(R))) != GEN_STAT(OK)) return stat;
    return GEN_STAT(OK);
}
...
static gen_stat set_ax_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if (gen_as(a, AS_X64(MOVQ), as_arg_i(a, ARG_ID(R), kv[0]->d[2]), as_arg_i(a, ARG_ID(X), kv[1]->d[2]), NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
...
static gen_stat set_au_fn(gen *g, void *s, te *ci, as *a, err **e) {
    ...
    if (gen_as(a, AS_X64(MOV), as_arg_i(a, ARG_ID(R), kv[0]->d[2]), as_arg_i(a, ARG_ID(R), kv[1]->d[2]), NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    drop_atm_kv_n(st, kv, ci, 2);
    return GEN_STAT(OK);
}


static gen_stat set_amu_fn(gen *g, void *s, te *ci, as *a, err **e) {
    gen_stat stat;
    te *kv[2];
    if ((stat = get_reg_n(s, ci, kv, 2)) != GEN_STAT(OK)) return gen_err(g, ci, e, "gen reg");
    if (gen_as(a, AS_X64(MOV), as_arg_i(a, ARG_ID(RM), kv[0]->d[2]), as_arg_i(a, ARG_ID(R), kv[1]->d[2]), NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    drop_atm_kv_n(s, kv, ci, 2);
    return GEN_STAT(OK);
...
static gen_stat set_as_fn(gen *g, void *s, te *ci, as *a, err **e) {
    gen_stat stat;
    te *kv, *from = ci->d[2].p;
    int32_t idx;
    if ((stat = get_reg(s, ci->d[1].p, &kv)) != GEN_STAT(OK)) return gen_err(g, ci, e, "gen reg");
    if (st_stka_idx(gen_var_g_t(from), from->d[1].u3, &idx) != GEN_STAT(OK)) return gen_err(g, ci, e, "gen stka inv idx");
    if (gen_as_rrmbd(a, AS_X64(MOV), R(AX), R(BP), idx, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(MOV), as_arg_i(a, ARG_ID(R), kv->d[2]), as_arg_i(a, ARG_ID(R), U3(R(AX))), NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    drop_atm_kv(s, kv, ci);
    return GEN_STAT(OK);
}
...
void gen_set(gen *g) {
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(V), X64_TYPE(M), GEN_CLS(V), X64_TYPE(M), set_vv_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(I), X64_TYPE(N), GEN_CLS(V), X64_TYPE(U6), set_ivu_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(I), X64_TYPE(N), GEN_CLS(I), X64_TYPE(U6), set_ii_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(MM), GEN_CLS(I), X64_TYPE(MM), set_ui_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(M), GEN_CLS(D), X64_TYPE(I6), set_ad_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(V), X64_TYPE(U6), GEN_CLS(T), X64_TYPE(U6), set_va_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(M), GEN_CLS(A), X64_TYPE(U6), set_au_fn);
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(MM), GEN_CLS(T), X64_TYPE(MM), set_au_fn);
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(MM), GEN_CLS(T), X64_TYPE(M), set_amu_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(M), GEN_CLS(V), X64_TYPE(U6), set_av_fn);
    ...
    GEN_OP_A2(g, GEN_OP(SET), GEN_CLS(T), X64_TYPE(MM), GEN_CLS(S), X64_TYPE(MM), set_as_fn);
}
