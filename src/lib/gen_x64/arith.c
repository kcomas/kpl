...
static gen_stat add_auauau_fn(gen *g, void *s, te *ci, as *a)  {
    ...
    if (kv[0]->d[2].u3 != kv[1]->d[2].u3) AS2(a, AS_X64(MOV), as_arg_i(g->aa, ARG_ID(R), U3(kv[0]->d[2].u3)), as_arg_i(g->aa, ARG_ID(R), U3(kv[1]->d[2].u3)), ci); /* not in place */
        AS2(a, AS_X64(ADD), as_arg_i(g->aa, ARG_ID(R), U3(kv[0]->d[2].u3)), as_arg_i(g->aa, ARG_ID(R), U3(kv[2]->d[2].u3)), ci);
...
#define AUAUBU(N, O) static gen_stat N##_auaubu_fn(gen *g, void *s, te *ci, as *a) { \
    ...
    if (kv[0]->d[2].u3 != kv[1]->d[2].u3) AS2(a, AS_X64(MOV), as_arg_i(g->aa,  ARG_ID(R), U3(kv[0]->d[2].u3)), as_arg_i(g->aa, ARG_ID(R), U3(kv[1]->d[2].u3)), ci); \
        AS2(a, AS_X64(O), as_arg_i(g->aa, ARG_ID(R), U3(kv[0]->d[2].u3)), as_arg_i(g->aa, ARG_ID(B), ((te*) ci->d[3].p)->d[2]), ci); \
