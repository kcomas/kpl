...
static gen_stat e_fn(gen *g, void *s, te *ci, as *a, err **e) {
    (void) s;
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(BX))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(10))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(11))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(12))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(13))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(14))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(PUSH), as_arg_i(a, ARG_ID(R), U3(R(15))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
...
static gen_stat l_fn(gen *g, void *s, te *ci, as *a, err **e)  {
    ...
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(15))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(14))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(13))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(12))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(11))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(10))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
    if (gen_as(a, AS_X64(POP), as_arg_i(a, ARG_ID(R), U3(R(BX))), NULL, NULL, NULL, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
...
static gen_stat leave_su_fn(gen *g, void *s, te *ci, as *a, err **e) {
    int32_t idx;
    te *tgt = ci->d[1].p;
    if (stk_va(s, tgt, &idx) != GEN_STAT(OK)) return gen_err(g, ci, e, "gen stkv inv idx");
    if (gen_as_rrmbd(a, AS_X64(MOV), R(AX), R(BP), idx, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
...
static gen_stat leave_sx_fn(gen *g, void *s, te *ci, as *a, err **e) {
    int32_t idx;
    te *tgt = ci->d[1].p;
    if (stk_va(s, tgt, &idx) != GEN_STAT(OK)) return gen_err(g, ci, e, "gen stkv inv idx");
    if (gen_as_rrmbd(a, AS_X64(MOV), R(AX), R(BP), idx, ci) != AS_STAT(OK)) return gen_err(g, ci, e, __FUNCTION__);
...
void gen_enter_leave(gen *g) {
    ...
    GEN_OP_A0(g, GEN_OP(LEAVE), leave_fn); // can not leave MM
    ...
    GEN_OP_A1(g, GEN_OP(LEAVE), GEN_CLS(S), X64_TYPE(MF6), leave_sx_fn);
}
